...
def intro():
    ...
    st.write("""
             This is the intoduction pafe. Use the dropdown to navigate to different pages.
             """)
...
def data_frame_demo():
    ...
    st.write("This page displays a random DataFrame.")
...
# Dictionary to map page name to functions
page_names_to_funcs = {
        "-": intro,
...
# Run the funtion associated with the selected page
