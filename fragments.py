...
def filter_and_file():
    ...
    new_cols[2].selectbox("Choose an option", ["Option 1", "Option 2", "Option 3"])
    new_cols[3].slider("Select value", 0, 100, 50)
    new_cols[4].text_input("Enter text")
    
toggle_and_text() 
cols = st.columns(2)
cols[0].selectbox("Choose an option", ["Option 1", "Option 2", "Option 3"], None)
